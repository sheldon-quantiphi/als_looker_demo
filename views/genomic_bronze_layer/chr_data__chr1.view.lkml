...
explore: chr_data__chr1 {
  hidden: no

  join: chr_data__chr1__call {
...
view: chr_data__chr1 {
  sql_table_name: `capsule-plateform.genomic_bronze_layer.chr_data__chr1`
    ;;
...
view: chr_data__chr1__call {
  dimension: ad {
    hidden: yes
    sql: AD ;;
  }

  dimension: chr_data__chr1__call {
    type: string
...
view: chr_data__chr1__filter {
  dimension: chr_data__chr1__filter {
    type: string
    description: "List of failed filters (if any) or \"PASS\" indicating the variant has passed all filters."
    sql: chr_data__chr1__filter ;;
  }
}

view: chr_data__chr1__call__ad {
  dimension: chr_data__chr1__call__ad {
    type: number
    description: "Allelic depths for the ref and alt alleles in the order listed"
    sql: chr_data__chr1__call__ad ;;
  }
}

view: chr_data__chr1__call__pl {
  dimension: chr_data__chr1__call__pl {
    type: number
    description: "Normalized, Phred-scaled likelihoods for genotypes as defined in the VCF specification"
    sql: chr_data__chr1__call__pl ;;
  }
}

view: chr_data__chr1__call__sb {
  dimension: chr_data__chr1__call__sb {
    type: number
    description: "Per-sample component statistics which comprise the Fisher's Exact Test to detect strand bias."
    sql: chr_data__chr1__call__sb ;;
  }
}

view: chr_data__chr1__call__genotype {
  dimension: chr_data__chr1__call__genotype {
    type: number
    description: "Genotype of the call. \"-1\" is used in cases where the genotype is not called."
    sql: chr_data__chr1__call__genotype ;;
  }
}

view: chr_data__chr1__alternate_bases {
  dimension: ac {
    type: number
  ...
  dimension: chr_data__chr1__alternate_bases {
    type: string
    description: "One record for each alternate base (if any)."
    hidden: yes
    sql: chr_data__chr1__alternate_bases ;;
  }
